  ...
  return (
    <main className="min-h-screen flex flex-col pb-24">
      ...
      <header className="p-6 pt-8 fade-up flex items-start justify-between">
        <div>
          <Link href="/dashboard" className="flex items-center gap-2 text-[var(--muted)] hover:text-[var(--text)] transition-colors mb-4 w-fit text-sm">
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
              <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/>
            </svg>
            Dashboard
          </Link>
          <p className="text-xs uppercase tracking-widest text-[var(--gold-dim)] mb-1">Owner</p>
